...
{
    public class GetByIdPolicyQuery : IRequest<GetByIdPolicyQueryResponse>
    {
    ...
    public class GetByIdPolicyQueryHandler : IRequestHandler<GetByIdPolicyQuery, GetByIdPolicyQueryResponse>
    {
        private readonly IPolicyRepository _policyRepository;
        private readonly IAffiliateRepository _affiliateRepository;
        private readonly IStatusRepository _statusRepository;

        public GetByIdPolicyQueryHandler(IPolicyRepository policyRepository, IAffiliateRepository affiliateRepository, IStatusRepository statusRepository)
        {
        ...
        public async Task<GetByIdPolicyQueryResponse> Handle(GetByIdPolicyQuery query, CancellationToken cancellationToken)
        {
            try
            {
                GetByIdPolicyQueryResponse result = new();
