...
{
    public class GetByIdClientQuery : IRequest<GetByIdClientQueryResponse>
    {
    ...
    public class GetByIdClientQueryHandler : IRequestHandler<GetByIdClientQuery, GetByIdClientQueryResponse>
    {
